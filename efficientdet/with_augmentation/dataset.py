...
class TrainDataset(Dataset):
    ...
    def __init__(self, annotation, data_dir, transforms=None):
        ...
        self.img_num = len(self.coco.getImgIds())
        self.data_len = self.img_num * 6

    def __getitem__(self, index: int):
        idx = index // self.img_num
    ...
    def __len__(self) -> int:
        # augmentation을 적용한 개수
        return self.data_len

    def load_image_and_boxes(self, index):
        idx = index // self.img_num
        aug_num = index % self.img_num
        ...
        image_id = self.coco.getImgIds()[idx]
    ...
    def load_cutmix_image_and_boxes(self, index, imsize=1024):
        ...
        indexes = [index] + [random.randint(0, self.data_len - 1) for _ in range(3)]
